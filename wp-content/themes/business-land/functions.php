...
/*we are adding custom post formarts here*/
function business_land_add_post_formats() {
...
add_action( 'after_setup_theme', 'business_land_add_post_formats' );
/**
...
function business_land_scripts() {
	...
	wp_enqueue_style( 'business-land-style', get_stylesheet_uri() );
